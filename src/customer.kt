...
/**
 * This is the "Super" class from which Commercial and Residentail shall inherit. It holds common elements
 */
...
/**
 * This is the first class to be created for commercial accounts
 */
class Commercial constructor( customerName: String,
    ...
    /**
     * This function will take the pertinent information, format it and output to the user
     */
    fun weeklycharge() {
...
/**
 * The second class that inherits from Customer, for our Residential Customers
 */
